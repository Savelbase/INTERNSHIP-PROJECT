...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = UserEditedEvent.class, name = EventTypeConstants.USER_EDITED),
        @JsonSubTypes.Type(value = ClientStatusChangedEvent.class, name = EventTypeConstants.CLIENT_STATUS_CHANGED),
