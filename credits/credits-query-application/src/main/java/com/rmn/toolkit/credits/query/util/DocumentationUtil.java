...
public class DocumentationUtil {
    public static final String CREDIT_ORDER_NOT_FOUND = "{\n" +
            "  \"timestamp\": \"2021-08-20T13:37:19.408Z\",\n" +
            "  \"errorType\": \"CREDIT_ORDER_NOT_FOUND\"\n" +
            "}";
    public static final String CREDIT_PRODUCT_NOT_FOUND = "{\n" +
            "  \"timestamp\": \"2021-08-20T13:37:19.408Z\",\n" +
            "  \"errorType\": \"CREDIT_PRODUCT_NOT_FOUND\"\n" +
            "}";
