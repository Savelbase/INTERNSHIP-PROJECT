package com.rmn.toolkit.user.command.dto.response.success;
...
@AllArgsConstructor
@Builder
public class VerificationCodeWithTokenResponse {
    ...
    @Schema(example = "20 min", description = "Access token expiration time is 20 min")
