...
-- pin_code = 777777
-- USERS
insert into clients(id, first_name, last_name, middle_name, resident, passport_number, accession_date_time,
                    mobile_phone, role_id, bank_client)
...
values ('0d3a68a1-5919-4914-bc20-839fae2480ac', '$2a$10$HP6mfnFyTOocyxVEFEFckuf4h9RxpwOKDoNLP/RKKwFnf/LQPzXTO',
       ...
       ('f943bf1a-e0d5-4388-bedd-e672903c9d71', '$2a$10$gEl4YFT/yZnFzPVKGCaFEOwoPxoFmaHgFlz20AHzQ6gDNGV9W3yra',
        'be_or_not_to_be', 'be_bee', '[{"type": "SMS", "state": false}, {"type": "PUSH", "state": false}, {"type": "EMAIL", "state": false}]',
