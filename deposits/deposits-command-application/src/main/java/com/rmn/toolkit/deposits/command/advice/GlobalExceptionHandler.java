package com.rmn.toolkit.deposits.command.advice;


import com.rmn.toolkit.deposits.command.dto.response.error.GeneralErrorTypeErrorResponse;
import com.rmn.toolkit.deposits.command.dto.response.error.GeneralMessageErrorResponse;
import com.rmn.toolkit.deposits.command.exception.locked.ClientStatusBlockedException;
import com.rmn.toolkit.deposits.command.exception.notfound.DepositNotFoundException;
import com.rmn.toolkit.deposits.command.exception.notfound.DepositProductNotFoundException;
import com.rmn.toolkit.deposits.command.exception.notfound.ClientNotFoundException;
import com.rmn.toolkit.deposits.command.exception.unauthorized.InvalidTokenException;
import com.rmn.toolkit.deposits.command.util.ResponseUtil;
