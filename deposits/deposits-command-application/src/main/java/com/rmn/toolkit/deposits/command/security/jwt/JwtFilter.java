package com.rmn.toolkit.deposits.command.security.jwt;
...
import com.rmn.toolkit.deposits.command.security.SecurityUtil;
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (StringUtils.hasText(jwt)) {
            try {
                ...
                securityUtil.checkIfClientIsBlocked(response);
