...
delete from agreements where id is not null;
...
insert into agreements(id, agreement_type, agreement_text, actual)
values ('5173d2bf-119c-4674-bb75-9ef023b49a56', 'PRODUCT_TERMS',
        'PRODUCT_TERMS: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec at leo ultrices, tempor mi mollis, varius ex. ' ||
       ...
       ('69229b0b-02c3-4c1f-84c1-4cab7e9b478b', 'GENERAL_CONDITIONS',
        'GENERAL_CONDITIONS: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec at leo ultrices, tempor mi mollis, varius ex. ' ||
        'Etiam et magna tellus. Donec sagittis non nisl a mollis. Sed a justo sollicitudin, viverra leo vel, suscipit urna. ' ||
        'Etiam fringilla ex eu finibus fringilla. Nulla faucibus tellus in augue consequat, ac consequat nibh ultricies. ' ||
        'Duis leo urna, sodales ut nunc quis, tincidunt placerat nibh. Donec non ultrices massa, gravida sollicitudin nulla. ' ||
        'Fusce at sem maximus, facilisis sem in, ullamcorper mauris. Praesent luctus dui sapien, ' ||
